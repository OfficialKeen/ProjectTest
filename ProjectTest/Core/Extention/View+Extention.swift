...
extension UIView {
    func setShadow(backgroundColor: UIColor, shadowColor: CGColor, shadowRadius: CGFloat, cornerRadius: CGFloat, opacity: Float, borderWidth: CGFloat, borderColor: CGColor) {
